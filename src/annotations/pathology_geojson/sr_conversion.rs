...
fn measurement_group(
    ...
    Ok(StructuredReportMeasurementGroup {
        ...
        finding_category: feature.semantics.category.clone(),
        finding_type: feature.semantics.property_type.clone(),
        algorithms: feature.semantics.algorithms.clone(),
        finding_sites: feature.semantics.anatomic_regions.clone(),
        reference,
        measurements,
        qualitative_evaluations,
    })
